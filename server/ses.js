...
//in server.js you will want to call this function in your server as a POST route whenever the user wants to reset the password
exports.sendEmail = function (recipient, message, subject) {
    return ses
        .sendEmail({
            Source: "Darryl Leung <darryl.leung@gmail.com>",
            Destination: {
